...
cependant, il ne faut pas oublier les frottements de l'air car comme dit plus haut, nous voulons simuler la réalité.
...
La dernière étape, consiste à regarder pour chaque itération avec notre x et y mis à jour, ou se trouve notre z grâce à la fonction de notre drap cité plus haut.
\[
